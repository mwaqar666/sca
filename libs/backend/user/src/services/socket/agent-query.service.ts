...
import type { IProjectCustomersResponseDto } from "@sca-shared/dto";
...
export class AgentQueryService extends SocketService {
	...
	public async fetchCustomersForAgentOfProject(agentSocket: AuthUserSocket): Promise<IProjectCustomersResponseDto> {
