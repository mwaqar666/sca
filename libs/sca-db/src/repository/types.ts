...
export type EntityCreateOrUpdateOptions<TEntity extends SequelizeBaseEntity<TEntity>> = EntityCreateOptions<TEntity> &
	Partial<EntityFinderOrResolverOption<TEntity>> &
